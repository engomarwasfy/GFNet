...
from models.unet_circular import BEV_Unet

class polar_net(nn.Module):
    ...
    def preprocess(self, pt_fea, xy_ind, num_pt_each):
    ...
    def reformat_data(self, processed_pooled_data, unq, batch_size, cur_dev, data_type):
        ...
        out_data_dim = [batch_size,self.grid_size[0],self.grid_size[1],self.pt_fea_dim]
    ...
    def forward(self, pt_fea, xy_ind, num_pt_each):

        cat_pt_fea, unq, unq_inv, batch_size, cur_dev = self.preprocess(pt_fea, xy_ind, num_pt_each)
